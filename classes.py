...
for class_data in data['classes']:
    ...
    ''', (class_data['name'], class_data['description'], class_data['hit_points_at_level1'],
          ...
          class_data['starting_equipment'], class_data.get('image_url', None)))
    ...
    for subclass in class_data.get('subclasses', []):
        c.execute('''
        INSERT INTO Subclasses (class_name, name, description)
        VALUES (?, ?, ?)
        ''', (class_name, subclass['name'], subclass['description']))
